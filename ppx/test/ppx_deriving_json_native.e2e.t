  ...
  >   (preprocess (pps jsonkit.ppx)))' > dune
  ...
  ERROR CASE DATA: 42
  Got expected unexpected variant: expected ["A"] or ["Other", _] but got 42
  ERROR CASE DATA: []
  Got expected unexpected variant: expected ["A"] or ["Other", _] but got []
  ERROR CASE DATA: [1]
  Got expected unexpected variant: expected ["A"] or ["Other", _] but got [1]
